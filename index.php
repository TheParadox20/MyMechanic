    ...
    <header>
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-2 LogIn" style="padding-top: 30px"> <a href="login.php">Client Login <img src="login.png"> </a> </div>
            </div>
        </div>
    </header>
</header>
